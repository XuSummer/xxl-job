...
<head>
	...
	<!-- DataTables -->
  	<link rel="stylesheet" href="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/adminlte/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  	<!-- daterangepicker -->
  	<link rel="stylesheet" href="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<!-- DataTables -->
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/adminlte/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/adminlte/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- daterangepicker -->
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/adminlte/bower_components/moment/moment.min.js"></script>
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/js/joblog.index.1.js"></script>
</body>
</html>
