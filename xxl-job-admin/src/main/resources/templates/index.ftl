...
<#-- echarts -->
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/plugins/echarts/echarts.common.min.js"></script>
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/js/index.js"></script>
</body>
</html>
