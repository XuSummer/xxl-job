...
<#-- echarts -->
<script src="${request.contextPath == '.' ? null : request.contextPath}/static/plugins/echarts/echarts.common.min.js"></script>
<script src="${request.contextPath == '.' ? null : request.contextPath}/static/js/index.js"></script>
</body>
</html>
