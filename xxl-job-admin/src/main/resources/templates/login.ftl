...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath == '.' ? null : request.contextPath}/static/adminlte/plugins/iCheck/square/blue.css">
...
<script src="${request.contextPath == '.' ? null : request.contextPath}/static/adminlte/plugins/iCheck/icheck.min.js"></script>
<script src="${request.contextPath == '.' ? null : request.contextPath}/static/js/login.1.js"></script>
