...
<head>
    ...
    <link rel="stylesheet" href="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/adminlte/plugins/iCheck/square/blue.css">
...
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/adminlte/plugins/iCheck/icheck.min.js"></script>
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/js/login.1.js"></script>
