...
<#-- cronGen -->
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/plugins/cronGen/cronGen<#if I18n.admin_i18n?default('')?length gt 0 >_${I18n.admin_i18n}</#if>.js"></script>
<script src="<#if request.contextPath != '.'>${request.contextPath}</#if>/static/js/jobinfo.index.1.js"></script>
</body>
</html>
