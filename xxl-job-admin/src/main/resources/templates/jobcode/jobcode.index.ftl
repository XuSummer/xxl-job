...
<@netCommon.commonScript />
    ...
    <#assign glueTypeModeSrc = "./static/plugins/codemirror/mode/clike/clike.js" />
    ...
    <#elseif jobInfo.glueType == "GLUE_SHELL" >
        <#assign glueTypeModeSrc = "./static/plugins/codemirror/mode/shell/shell.js" />
        <#assign glueTypeIdeMode = "text/x-sh" />
    <#elseif jobInfo.glueType == "GLUE_PYTHON" >
        <#assign glueTypeModeSrc = "./static/plugins/codemirror/mode/python/python.js" />
        <#assign glueTypeIdeMode = "text/x-python" />
    <#elseif jobInfo.glueType == "GLUE_PHP" >
        <#assign glueTypeModeSrc = "./static/plugins/codemirror/mode/php/php.js" />
        <#assign glueTypeIdeMode = "text/x-php" />
        <#assign glueTypeModeSrc02 = "./static/plugins/codemirror/mode/clike/clike.js" />
    <#elseif jobInfo.glueType == "GLUE_NODEJS" >
        <#assign glueTypeModeSrc = "./static/plugins/codemirror/mode/javascript/javascript.js" />
        <#assign glueTypeIdeMode = "text/javascript" />
    <#elseif jobInfo.glueType == "GLUE_POWERSHELL" >
        <#assign glueTypeModeSrc = "./static/plugins/codemirror/mode/powershell/powershell.js" />
...
<script src="./static/plugins/codemirror/addon/hint/anyword-hint.js"></script>

<script>
var id = '${jobInfo.id}';
var ideMode = '${glueTypeIdeMode}';
</script>
<script src="./static/js/jobcode.index.1.js"></script>
